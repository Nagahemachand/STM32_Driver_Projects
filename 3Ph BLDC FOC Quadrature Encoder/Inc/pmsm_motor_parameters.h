...
#define RS                      4.83 /* Stator resistance , ohm*/
#define LS                      0.00224 /* Stator inductance, H
...
#define MOTOR_VOLTAGE_CONSTANT  5.4 /*!< Volts RMS ph-ph /kRPM */
#define NOMINAL_CURRENT_A       4.97

#define ID_DEMAG_A              -4.97 /*!< Demagnetization current */
...
/*** Quadrature encoder ***/
#define M1_ENCODER_PPR          2048  /*!< Number of pulses per
                                            revolution */
