...
#define DEFAULT_TARGET_SPEED_RPM            1620
...
/* Phase 2 */
#define PHASE2_DURATION                     3600 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT             (1800*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A              4.97

/* Phase 3 */
#define PHASE3_DURATION                     0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT             (1800*SPEED_UNIT/U_RPM)
...
#define PHASE5_FINAL_SPEED_UNIT             (1800*SPEED_UNIT/U_RPM)
...
#define OBS_MINIMUM_SPEED_RPM               1620
